...
class Pdf(Type):
    ...
    def match(self, buf):
        ...
        if len(buf) > 3 and buf[0] == 0xEF and buf[1] == 0xBB and buf[2] == 0xBF:  # noqa E129
            buf = buf[3:]

        return len(buf) > 3 and buf[0] == 0x25 and buf[1] == 0x50 and buf[2] == 0x44 and buf[3] == 0x46
...
class Swf(Type):
    ...
    def match(self, buf):
        return (
            len(buf) > 2 and (buf[0] == 0x46 or buf[0] == 0x43 or buf[0] == 0x5A) and buf[1] == 0x57 and buf[2] == 0x53
        )
...
class Rtf(Type):
    ...
    def match(self, buf):
        return (
            len(buf) > 4 and buf[0] == 0x7B and buf[1] == 0x5C and buf[2] == 0x72 and buf[3] == 0x74 and buf[4] == 0x66
        )
...
class Nes(Type):
    ...
    def match(self, buf):
        return len(buf) > 3 and buf[0] == 0x4E and buf[1] == 0x45 and buf[2] == 0x53 and buf[3] == 0x1A
...
class Crx(Type):
    ...
    def match(self, buf):
        return len(buf) > 3 and buf[0] == 0x43 and buf[1] == 0x72 and buf[2] == 0x32 and buf[3] == 0x34
...
class Sqlite(Type):
    ...
    def match(self, buf):
        return len(buf) > 3 and buf[0] == 0x53 and buf[1] == 0x51 and buf[2] == 0x4C and buf[3] == 0x69
...
class Z(Type):
    ...
    def match(self, buf):
        return len(buf) > 1 and ((buf[0] == 0x1F and buf[1] == 0xA0) or (buf[0] == 0x1F and buf[1] == 0x9D))
...
class Lz(Type):
    ...
    def match(self, buf):
        return len(buf) > 3 and buf[0] == 0x4C and buf[1] == 0x5A and buf[2] == 0x49 and buf[3] == 0x50
...
class Elf(Type):
    ...
    def match(self, buf):
        return len(buf) > 52 and buf[0] == 0x7F and buf[1] == 0x45 and buf[2] == 0x4C and buf[3] == 0x46
...
class Lz4(Type):
    ...
    def match(self, buf):
        return len(buf) > 3 and buf[0] == 0x04 and buf[1] == 0x22 and buf[2] == 0x4D and buf[3] == 0x18
