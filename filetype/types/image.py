...
class Apng(Type):
    ...
    def match(self, buf):
        if len(buf) > 8 and buf[:8] == bytearray([0x89, 0x50, 0x4E, 0x47, 0x0D, 0x0A, 0x1A, 0x0A]):
            # cursor in buf, skip already read 8 bytes
            i = 8
            while len(buf) > i:
...
class Png(Type):
    ...
    def match(self, buf):
        return len(buf) > 3 and buf[0] == 0x89 and buf[1] == 0x50 and buf[2] == 0x4E and buf[3] == 0x47
    ...
    def match(self, buf):
        return (
            ...
            and (
                ...
                or (buf[0] == 0x4D and buf[1] == 0x4D and buf[2] == 0x0 and buf[3] == 0x2A)
            )
            and buf[8] == 0x43
            and buf[9] == 0x52
        )
...
class Psd(Type):
    ...
    def match(self, buf):
        return len(buf) > 3 and buf[0] == 0x38 and buf[1] == 0x42 and buf[2] == 0x50 and buf[3] == 0x53
...
class Ico(Type):
    ...
    def match(self, buf):
        return len(buf) > 3 and buf[0] == 0x00 and buf[1] == 0x00 and buf[2] == 0x01 and buf[3] == 0x00
...
class Xcf(Type):
    ...
    def match(self, buf):
        return buf[:10] == bytearray([0x67, 0x69, 0x6D, 0x70, 0x20, 0x78, 0x63, 0x66, 0x20, 0x76])
...
class Qoi(Type):
    ...
    def match(self, buf):
        return len(buf) > 3 and buf[0] == 0x71 and buf[1] == 0x6F and buf[2] == 0x69 and buf[3] == 0x66
