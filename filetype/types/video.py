...
class Flv(Type):
    ...
    def match(self, buf):
        return len(buf) > 3 and buf[0] == 0x46 and buf[1] == 0x4C and buf[2] == 0x56 and buf[3] == 0x01
...
class Mpeg(Type):
    ...
    def match(self, buf):
        return len(buf) > 3 and buf[0] == 0x0 and buf[1] == 0x0 and buf[2] == 0x1 and buf[3] >= 0xB0 and buf[3] <= 0xBF
